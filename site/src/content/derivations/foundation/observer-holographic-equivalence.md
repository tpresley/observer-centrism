...
- **Corollary 4.6 (operational completeness of the sheaf)**: universal application of Corollary 4.5 across all observers. Establishes that the framework's manifold-with-boundary stalks suffice to capture all testable content; any hypothetical geometric extension is operationally invisible.
