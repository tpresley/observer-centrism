...
3. **Singularity resolution** *(resolved — downstream)*: Fully addressed by [Singularity Resolution](/derivations/spacetime/singularity-resolution), which establishes curvature bounds at Planck density via the holographic entropy bound, and derives coherence bounces (cosmological) and regular cores (black hole) via a model-independent argument from the contraposition of the Penrose-Hawking theorems.
