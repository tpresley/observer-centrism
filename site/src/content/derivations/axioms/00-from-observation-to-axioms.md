...
**The argument.** Five operational definitions — of observation, observer, persistence, closed ontology, and composition — are stated below. Each captures one aspect of what it means to observe. From these five definitions, the formal apparatus of the three axioms largely follows: the σ-algebra and coherence measure of [Coherence Conservation](/derivations/axioms/coherence-conservation), the observer triple and Hausdorff topology of [The Observer Definition](/derivations/axioms/observer-definition), and much of the dynamical structure of [Loop Closure](/derivations/axioms/loop-closure). Of the forty formal elements introduced across the three axioms, thirty-seven are forced by these five definitions; only three require additional input.

**The result.** The framework's honest claim is: physics from five operational definitions about observation, plus three genuinely additional inputs (smooth dynamics, exclusion of quasi-periodicity, and symplectic structure). Everything else is a consequence. The three additional inputs are small, well-motivated, and explicitly declared.
...
**Loop Closure** ([Axiom 3](/derivations/axioms/loop-closure)). Persistence (Definition 3) forces self-sustaining one-parameter dynamics — the current state must determine the next state. Finite resources (from Axiom 1) combined with the drift bound forces recurrence: a non-recurrent flow on a compact state space has finite lifetime. Once the flow recurs, the $U(1)$ action, free orbits, Lyapunov stability, invariant Riemannian metric, and positive coherence cost all follow. Ten of the thirteen formal elements are forced by the operational definitions. The remaining three — smooth dynamics, exclusion of quasi-periodicity, and symplectic structure — require additional input and are identified explicitly below.

## Three Additional Inputs

Three formal elements go beyond what the five operational definitions entail. Each is well-motivated, but none is a logical consequence of operational observerhood alone.

1. **Smooth ($C^\infty$) dynamics** ([Loop Closure](/derivations/axioms/loop-closure), Operational Grounding). Continuity of the observer's dynamics is forced by the operational requirement that similar states produce similar residues. Smoothness — infinite differentiability — goes beyond this. It is required because smooth structure is the minimal setting in which the three axioms can communicate: the Noether mechanism that links the $U(1)$ symmetry (Axiom 3) to the conserved invariant (Axiom 2) to the coherence measure (Axiom 1) requires a Lie algebra, a smooth action, and a smooth manifold. Without smoothness, the three axioms remain individually satisfiable but the Noether mechanism is severed. Three independent downstream requirements converge on $C^1$ differentiability (Noether's theorem, coherence cost, Fisher metric), and Whitney's theorem upgrades $C^1$ to $C^\infty$.

2. **Exclusion of quasi-periodicity** ([Loop Closure](/derivations/axioms/loop-closure), Operational Grounding). The drift bound forces recurrence, but quasi-periodic flows (orbits dense in a higher-dimensional torus $T^k$ with $k > 1$ incommensurate frequencies) also recur without exact closure. The framework requires exact periodicity — a single fundamental frequency — because quantum mechanics requires discrete energy levels ($E = n\hbar\omega$), which arise only from exact $U(1)$ symmetry. A quasi-periodic observer would have a continuous power spectrum, inconsistent with the discrete structure that the framework derives downstream.

3. **Symplectic structure** ([Loop Closure](/derivations/axioms/loop-closure), Operational Grounding). The Noether pair equivalence (Theorem 5.1 of the Loop Closure page) requires a symplectic form on the state space, preserved by the flow. This enables the identification of the $U(1)$ symmetry with a conserved charge via the moment map. Symplectic structure is physically motivated — state spaces of classical mechanical systems and projective Hilbert spaces carry natural symplectic forms — but it is not derived from the operational definitions.

## Open Gaps

1. **Smooth dynamics promotion.** If the structural necessity of smooth dynamics for inter-axiom coherence (the Noether mechanism) could be formalized as an operational requirement, smooth dynamics might become operationally forced. This would require showing that "the axioms must communicate" is itself a consequence of observerhood.

2. **Quasi-periodicity exclusion.** If a single-frequency requirement could be derived from operational observerhood — perhaps via a composition argument showing that quasi-periodic observers decompose into multiple independent sub-observers by Definition 5 — the exclusion might become operationally forced.

3. **Symplectic structure.** If the symplectic form could be derived from the $U(1)$ action on the state space (perhaps via the cotangent bundle construction), it might become operationally forced.
