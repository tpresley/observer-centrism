...
**(ii) Yukawa hierarchy from winding geometry.** The Yukawa couplings $y_f$ are determined by the overlap between the fermion winding configuration and the crystallization direction in the quaternionic phase space. By [Three Generations](/derivations/particles/three-generations) (Theorem 4.2), $y_k^{(f)} \sim e^{-\alpha_k^{(f)}/g_{\text{eff}}^2}$, where $\alpha_k^{(f)}$ is the angular separation between fermion type $f$'s generation-$k$ winding axis and the crystallization axis. Each fermion type (up-quarks, down-quarks, charged leptons) has its own winding-axis triple, related by the CKM and PMNS rotations (Proposition 5.2 of [Three Generations](/derivations/particles/three-generations)). The inter-generation ordering $\alpha_3 < \alpha_2 < \alpha_1$ gives $y_3 > y_2 > y_1$ within each type. The inter-type splittings (e.g., $m_t \neq m_b$ within generation 3) arise from the different winding-axis orientations of the up and down sectors. $\square$

### Step 7: EWSB as Type II Fusion

Steps 1–6 above recover all observable consequences of the Higgs mechanism (W/Z masses, Higgs boson, Yukawa couplings) from the coherence-crystallization picture using the standard physics machinery. The framework's [Three Interaction Types](/derivations/interactions/three-types) classification (Theorem 5.1) supplies a complementary structural reading of the broken-phase content.

**Proposition 7.1 (Massive vectors as Type II composites).** *Each massive vector observer $V \in \{W^+, W^-, Z\}$ is a Type II composite (Definition 4.3 of [Three Interaction Types](/derivations/interactions/three-types)) of one transverse pre-EWSB gauge mode and one Goldstone scalar mode of the Higgs doublet, with the constituents pushed off-ledger into the massive-vector polarization fiber.*

*Proof.* The covariant derivative evaluated at the Higgs VEV (Theorem 3.1) generates each massive-vector mass by combining a transverse gauge polarization with a Goldstone direction. By the equivalence theorem, in the high-energy limit the longitudinal massive-vector polarization scatters identically to the absorbed Goldstone — the operational content of "the Goldstone is absorbed into the longitudinal polarization": the physically realized state space of $V$ is the 3-dimensional polarization fiber that *results* from the combination, not the union of constituents' fibers.

In framework terms, the broken-phase Cauchy slice presents one ledgered observer $\mathcal{O}_V = (\Sigma_V, I_V, \mathcal{B}_V)$ per massive vector — with $\Sigma_V$ the polarization fiber, $I_V$ the rest-energy / Compton-period invariant, and $\mathcal{B}_V$ the self/non-self boundary of the vector's interactions — where the symmetric-phase content had two unledgered modes (transverse gauge + Goldstone scalar). Both constituents are pushed through the projection $\pi$ implicit in the covariant-derivative-induced mass term and clock-paused per [Memory-Persistence Tradeoff](/derivations/thermodynamics-ext/memory-persistence-tradeoff) Theorem 5.1. The ledgered-observer count of the electroweak sector therefore satisfies $\dim \Sigma_V < \dim \Sigma_{\text{gauge}} + \dim \Sigma_{\text{Goldstone}}$ in the ledger-count reading of Definition 4.3 (one composite slot replacing two constituent slots), even though the polarization-fiber arithmetic ($2 + 1 = 3$) is preserved. $\square$

**Corollary 7.2 (Photon is a Type-I quantum, not on the ledger).** *The unbroken $U(1)_{em}$ generator survives the crystallization, and its quantized phase-carrier — the photon — propagates between charged observers along the null trajectory $L = cT$. By [Speed of Light](/derivations/spacetime/speed-of-light) Proposition 6.2 the photon is a Type-I quantum, not an observer, and does not contribute to the broken-phase ledgered-observer count.*

**Remark (Ledgered-entity bookkeeping across the EWSB transition).** The mode-count is preserved but the ledger-count changes. Pre-EWSB the electroweak sector contains 4 gauge field species ($W^1, W^2, W^3, B$), all unledgered (Type-I quanta of the unbroken gauge group, no rest frame), plus 4 Higgs doublet real scalar modes, none ledgered (the symmetric-phase potential is unstable and the modes have no well-defined Compton period). Post-EWSB the slice presents 4 ledgered observers — 3 massive vectors ($W^+, W^-, Z^0$, each a Type II composite per Proposition 7.1) plus the Higgs radial mode (an elementary scalar observer satisfying Axiom 3 via the phase-space $U(1)$ realization of [Loop Closure](/derivations/axioms/loop-closure) Theorem 0.5; placement {Elementary observer, Self-conjugate} per [Entity Category Taxonomy](/derivations/foundation/entity-category-taxonomy)) — and 1 off-ledger Type-I quantum (the photon, Corollary 7.2). The symmetric-phase ledgered-observer count is zero. EWSB is the cosmological-scale Type II fusion event that *creates* the electroweak-sector ledgered observers (massive vectors + Higgs), by analogy to QCD confinement creating the hadronic ledgered observers.

**Remark (Mass as fusion coherence signature).** The massive-vector mass $m_V$ is the energy-scale signature of the binding coherence holding the transverse gauge mode and the absorbed Goldstone on the composite's manifold — structurally analogous to nuclear binding energy (deuteron mass deficit) and to the QCD chiral-confinement contribution to hadron mass (proton mass dominantly from gluon and chiral condensates, not from valence-quark current masses). In all three cases the composite's mass is the binding coherence's energy scale, and the reverse Type II channel — decay back to constituents or to lighter Type II composites — has rate determined by channel barrier and available phase space (Definition 7.2 of [Three Interaction Types](/derivations/interactions/three-types)). For W and Z the channels $W^+ \to \ell^+ \nu_\ell$ and $Z \to \ell^+\ell^-, \nu\bar\nu, q\bar q$ have no significant barrier at the EW scale, so the cycle count $N_{\text{cycles}} \sim 6$ sits deep in the ephemeral regime ([Three Interaction Types](/derivations/interactions/three-types) Step 8 tabulation).

**Remark (EWSB and confinement as parallel Type II events).** EWSB and QCD confinement are the framework's two paradigm Type II fusion events at fundamental scales. Confinement fuses three quarks (or a quark–antiquark pair) into a single ledgered hadron observer, with the binding gluons clock-paused inside the hadron's $\Sigma$. EWSB fuses each transverse gauge mode + Goldstone scalar into a single ledgered massive vector observer, with the Goldstone clock-paused inside the vector's $\Sigma$. Both are dimension reductions in the ledgered-observer count even when the underlying field-theoretic dof count is preserved (the quarks' color/spin polarizations are reorganized rather than eliminated; the Goldstone's polarization is reorganized into the longitudinal massive-vector polarization). The structural parallel places EWSB in the same ontological category as the empirically uncontroversial confinement-as-fusion picture.

## Consistency Model

**Theorem 8.1.** *The Standard Model with the Higgs mechanism provides a consistency model.*
...
- **Fermion masses** (Proposition 6.1): All charged fermion masses follow $m_f = y_f v/\sqrt{2}$. The mass hierarchy ($m_t/m_e \sim 3.4 \times 10^5$) is consistent with the exponential Yukawa hierarchy from winding-axis misalignment. $\checkmark$
- **Type II structural recasting** (Proposition 7.1, Corollary 7.2): The framework's Three Interaction Types classification reads each massive vector $V \in \{W^+, W^-, Z\}$ as a Type II composite of (transverse pre-EWSB gauge mode, Goldstone scalar) at the ledgered-observer level, with the photon as the off-ledger Type-I quantum of unbroken $U(1)_{em}$. The reading is consistent with the Goldstone equivalence theorem and with the Type II clock-pause result of [Memory-Persistence Tradeoff](/derivations/thermodynamics-ext/memory-persistence-tradeoff) Theorem 5.1. $\checkmark$ $\square$
...
- Proposition 7.1, Corollary 7.2: Massive vectors as Type II composites; photon as off-ledger Type-I quantum. The structural recasting follows from the existing physics machinery (covariant-derivative mass term + Goldstone equivalence theorem + unbroken $U(1)_{em}$) combined with [Three Interaction Types](/derivations/interactions/three-types) Definition 4.3 in its ledgered-observer-count reading. No new mathematical content beyond the relabeling.
...
2. **Higgs self-coupling**: The value $\lambda \approx 0.13$ (determining $m_h = 125$ GeV) is not predicted — it depends on the shape of the coherence potential near the crystallization.
3. **Custodial symmetry**: The approximate $SU(2)$ custodial symmetry protecting $\rho = m_W^2/(m_Z^2\cos^2\theta_W) \approx 1$ should follow from the quaternionic structure but is not explicitly derived.
4. **Electroweak phase transition**: The cosmological electroweak phase transition (first-order vs. crossover) depends on the detailed dynamics of the crystallization, relevant for [Baryogenesis](/derivations/cosmology/baryogenesis).
## Addressed Gaps
...
2. **Higgs category placement** — *Resolved by [Loop Closure](/derivations/axioms/loop-closure) Theorem 0.5 + [Entity Category Taxonomy](/derivations/foundation/entity-category-taxonomy) Theorem 3.1*: Axiom 3's $U(1)$ admits both phase-space (rest-frame Compton oscillator) and internal (gauge phase) realizations. The Higgs radial mode satisfies all observer axioms via the phase-space realization at $T_H \sim 3 \times 10^{-26}$ s with rest-energy Noether charge, and has zero internal charge under every unbroken framework symmetry. It is therefore an {Elementary observer, Self-conjugate} entity in the two-axis taxonomy — the canonical example of that cell. The post-EWSB ledgered-observer count of the electroweak sector (Step 7 above) is 4: $W^+$ ({Type II composite, Internal-charge-carrier}), $W^-$ ({Type II composite, Internal-charge-carrier}), $Z^0$ ({Type II composite, Self-conjugate}), and Higgs ({Elementary observer, Self-conjugate}); the photon is off-ledger as Type-I quantum.
