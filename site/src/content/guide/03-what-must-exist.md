...
subtitle: "How the axioms force observers, multiplicity, and antimatter into being"
order: 3
openingQuestion: "If you require that something conserved can observe itself, what is the simplest thing that qualifies? And can it be alone?"
physicsQuestions:
  - "What is the simplest possible observer?"
  - "Why can't a universe contain just one observer?"
  - "Why does matter come in particle-antiparticle pairs?"
  - "What does the minimal observer look like?"
relatedDerivations:
