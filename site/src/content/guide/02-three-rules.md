...
> **On solid ground:** The three axioms are precisely stated, independent, and their sufficiency is tested across {{derivedCount}} derived derivations covering the span from quantum mechanics to general relativity to the information paradox. {{derivationsWithoutPostulatesCount}} derivations require no additional assumptions whatsoever.
