...
*Verification:*
- **(R1)**: $I_{12}$ is invariant under independent $U(1) \times U(1)$ action: $I_{12}(\theta_1 + \alpha, \theta_2 + \alpha) = \cos(\theta_1 - \theta_2) = I_{12}(\theta_1, \theta_2)$. More precisely, it is invariant under the diagonal $U(1)$ subgroup. ✓
