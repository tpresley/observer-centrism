...
| Interpretation | Fluctuation source | Predicted $\alpha_H$ |
|---|---|---|
| Framework (relational-invariant coarse-graining) | Holographically-counted bits, $N_{\text{eff}} = A/(4\ell_P^2)$ | $1/4$ |
| Generic causet (Poisson substrate) | Substrate Planck cells, $N_{\text{bulk}} = A/\ell_P^2$ | $\sim 1$ |
