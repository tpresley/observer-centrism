...
- Spinor observers: derivation works at the scalar level. Fermionic observers carry Dirac-spinor structure.
...
2. **Spinor (Dirac) extension.** Extending to spinor observers requires the Dirac Lagrangian treatment; the pattern signal is expected to take a spinor-weighted form reducing to the scalar Yukawa in the spin-averaged limit. *Difficulty: MODERATE.*
