...
> **Work in progress:** The three-generations argument relies on the generation-axis correspondence postulate, which is motivated but not derived. The mass hierarchy derivation requires a tunneling-crystallization correspondence postulate. Recent derivations extend the framework further: [neutrino masses](/derivations/particles/neutrino-masses) are derived as Majorana (self-conjugate windings) with a seesaw mechanism predicting normal mass ordering; [singularity resolution](/derivations/spacetime/singularity-resolution) shows how the discrete relational network bounds curvature and replaces the Big Bang with a coherence bounce; [causal set statistics](/derivations/holography/causal-set-statistics) unifies the holographic noise and dark matter predictions from a single statistical foundation; and [electroweak symmetry breaking](/derivations/gauge/electroweak-breaking) derives the Higgs mechanism as a coherence crystallization, generating W/Z boson masses and protecting the electroweak hierarchy without fine-tuning. All nine provisional derivations have tightened proofs and verified consistency models. Five newer derivations extend the frontier further: three have reached provisional status — [anomaly cancellation](/derivations/gauge/anomaly-cancellation) shows that the chirality-selected fermion content from the division-algebra decomposition automatically satisfies all four independent anomaly cancellation conditions; [chiral symmetry breaking](/derivations/gauge/chiral-symmetry-breaking) derives the QCD chiral condensate from coherence minimization in the confining phase, producing pions as pseudo-Goldstone bosons; and [leptogenesis](/derivations/cosmology/leptogenesis) connects the framework's Majorana neutrinos to the baryon asymmetry via resonant heavy neutrino decays, resolving the CKM insufficiency problem. Two further derivations have reached draft status: [Weinberg angle](/derivations/gauge/weinberg-angle) (predicting sin²θ_W from coupling constant ratios) and [ER=EPR formalization](/derivations/holography/er-epr) (making the entanglement–wormhole correspondence rigorous).
