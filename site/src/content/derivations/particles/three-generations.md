...
3. **Neutrino mass mechanism** *(resolved — downstream)*: Fully addressed by [Neutrino Masses](/derivations/particles/neutrino-masses), which establishes Majorana nature from the pseudo-real $SU(2)$ representation — the self-conjugacy of the fundamental representation forces $\nu_R = \nu_R^c$, consistent with the self-conjugate winding interpretation.
