...
Nearly all of this axiom's formal structure follows from the five operational definitions established in [From Observation to Axioms](/derivations/axioms/00-from-observation-to-axioms). Only one element — the exclusion of quasi-periodicity — requires additional input. This section traces the forcing arguments.
...
Twelve of the thirteen formal elements of this axiom are forced by the operational definitions. One — the exclusion of quasi-periodicity in favor of exact periodicity — requires additional physical input beyond operational observerhood.
